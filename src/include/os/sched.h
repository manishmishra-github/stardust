...
struct fp_regs
{
    ...
    unsigned long xmmh9;
    unsigned long xmm10;
    unsigned long xmmh10;
    unsigned long xmm11;
    unsigned long xmmh11;
    unsigned long xmm12;
    unsigned long xmmh12;
    unsigned long xmm13;
    unsigned long xmmh13;
    unsigned long xmm14;
    unsigned long xmmh14;
    unsigned long xmm15;
    unsigned long xmmh15;
...
#define arch_switch_threads(prev, next, last)                      \
    do                                                             \
    {                                                              \
